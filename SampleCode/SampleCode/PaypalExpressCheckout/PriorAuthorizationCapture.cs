...
namespace net.authorize.sample
{
    public class PayPalPriorAuthorizationCapture
    {
        ...
        //    return response;
        //}
        public static void PayPalPriorAuthorizationCaptureExec(String ApiLoginID, String ApiTransactionKey)
        {
            using (CsvReader csv = new CsvReader(new StreamReader(new FileStream(@"../../../CSV_DATA/PriorAuthorizationCapture.csv", FileMode.Open)), true))
            {
                Console.WriteLine("PayPal Prior Authorization Transaction");
                int flag = 0;
                ...
                using (CsvFileWriter writer = new CsvFileWriter(new FileStream(@"../../../CSV_DATA/Outputfile.csv", FileMode.Open)))
                {
                    ...
                    while (csv.ReadNextRecord())
                    {
                        ...
                        try
                        {
                                ...
                                && response.transactionResponse.messages != null)
                            {
                                try
                                {
                                    ...
                                    row1.Add("PAC_00" + flag.ToString());
                                    row1.Add("PriorAuthorizeCapture");
                                    row1.Add("Pass");
                        ...
                        catch (Exception e)
                        {
                            ...
                            row2.Add("PAC_00" + flag.ToString());
                            row2.Add("PriorAuthorizeCapture");
                            row2.Add("Fail");
