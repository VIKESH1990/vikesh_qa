...
namespace net.authorize.sample
{
    public class PayPalAuthorizeCapture
    {
        ...
        //    return response;
        //}
        public static void PayPalAuthorizeCaptureExec(String ApiLoginID, String ApiTransactionKey)
        {
            using (CsvReader csv = new CsvReader(new StreamReader(new FileStream(@"../../../CSV_DATA/AuthorizationAndCapture.csv", FileMode.Open)), true))
            {
                Console.WriteLine("PayPal Authorize Capture Transaction");
                int flag = 0;
                ...
                using (CsvFileWriter writer = new CsvFileWriter(new FileStream(@"../../../CSV_DATA/Outputfile.csv", FileMode.Open)))
                {
                    ...
                    while (csv.ReadNextRecord())
                    {
                        ...
                        try
                        {
                                ...
                                && response.transactionResponse.messages != null)
                            {
                                try
                                {
                                    ...
                                    row1.Add("AAC_00" + flag.ToString());
                                    row1.Add("AuthorizationAndCapture");
                                    row1.Add("Pass");
                        ...
                        catch (Exception e)
                        {
                            ...
                            row2.Add("AAC_00" + flag.ToString());
                            row2.Add("AuthorizationAndCapture");
                            row2.Add("Fail");
