...
namespace net.authorize.sample
{
    public class PayPalAuthorizeOnly
    {
        ...
        //    return response;
        //}
        public static void PayPalAuthorizeOnlyExec(String ApiLoginID, String ApiTransactionKey)
        {
            using (CsvReader csv = new CsvReader(new StreamReader(new FileStream(@"../../../CSV_DATA/AuthorizeOnly.csv", FileMode.Open)), true))
            {
                Console.WriteLine("PayPal Authorize Only Transaction");
                int flag = 0;
                ...
                using (CsvFileWriter writer = new CsvFileWriter(new FileStream(@"../../../CSV_DATA/Outputfile.csv", FileMode.Open)))
                {
                    ...
                    while (csv.ReadNextRecord())
                    {
                        ...
                        try
                        {
                                ...
                                && response.transactionResponse.messages != null)
                            {
                                try
                                {
                                    ...
                                    row1.Add("AO_00" + flag.ToString());
                                    row1.Add("AuthorizationOnly");
                                    row1.Add("Pass");
                        ...
                        catch (Exception e)
                        {
                            ...
                            row2.Add("AO_00" + flag.ToString());
                            row2.Add("AuthorizationOnly");
                            row2.Add("Fail");
