...
namespace net.authorize.sample
{
    public class PayPalAuthorizeOnlyContinue
    {
        ...
        //    return response;
        //}
        public static void PayPalAuthorizeOnlyContinueExec(String ApiLoginID, String ApiTransactionKey)
        {
            using (CsvReader csv = new CsvReader(new StreamReader(new FileStream(@"../../../CSV_DATA/AuthorizeOnlyContinued.csv", FileMode.Open)), true))
            {
                Console.WriteLine("PayPal Authorize Only-Continue Transaction");
                int flag = 0;
                ...
                using (CsvFileWriter writer = new CsvFileWriter(new FileStream(@"../../../CSV_DATA/Outputfile.csv", FileMode.Open)))
                {
                    ...
                    while (csv.ReadNextRecord())
                    {
                        ...
                        try
                        {
                                ...
                                && response.transactionResponse.messages != null)
                            {
                                try
                                {
                                    ...
                                    row1.Add("AOC_00" + flag.ToString());
                                    row1.Add("AuthorizationOnlyContinued");
                                    row1.Add("Pass");
                        ...
                        catch (Exception e)
                        {
                            ...
                            row2.Add("AOC_00" + flag.ToString());
                            row2.Add("AuthorizationOnlyContinued");
                            row2.Add("Fail");
