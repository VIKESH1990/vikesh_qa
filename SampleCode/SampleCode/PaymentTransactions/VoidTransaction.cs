...
namespace net.authorize.sample
{
    public class VoidTransaction
    {
        ...
        //      return response;
        //  }
        public static void VoidTransactionExec(String ApiLoginID, String ApiTransactionKey)
        {

            using (CsvReader csv = new CsvReader(new StreamReader(new FileStream(@"../../../CSV_DATA/voidTransaction.csv", FileMode.Open)), true))
            {
                Console.WriteLine("Void Transaction");
                int flag = 0;
                ...
                using (CsvFileWriter writer = new CsvFileWriter(new FileStream(@"../../../CSV_DATA/Outputfile.csv", FileMode.Open)))
                {
                    ...
                    while (csv.ReadNextRecord())
                    {
                        ...
                        try
                        {
                                ...
                                && response.transactionResponse.messages != null)
                            {
                                try
                                {
                                    ...
                                    row1.Add("VT_00" + flag.ToString());
                                    row1.Add("VoidTransaction");
                                    row1.Add("Pass");
                        ...
                        catch (Exception e)
                        {
                            ...
                            row2.Add("VT_00" + flag.ToString());
                            row2.Add("VoidTransaction");
                            row2.Add("Fail");
